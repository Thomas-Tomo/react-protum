...
const RisingDamp = () => {
  return (
    <div className={styles.container}>
      ...
      <p>
        The source of a rising damp problem is determined through the analysis
        of data provided by an electronic moisture meter (moisture monitor),
        backed up in some cases by laboratory tests.
      </p>
      <p>
      ...
      <p>
        ...
        soil and deposits them on the face of the plaster as the water
        evaporates from the surface. This causes persistently damp walls even
        after the rising damp problem has been treated. Protum Services
        recommend removing all defective damp plaster that has been contaminated
        by the salts and replacing it strictly in accordance with our damp
        proofing specification. This is made up of three coat work incorporating
        specialised plaster and renders, special damp proofing agents and salt
        free sand.
      </p>
      <p>
